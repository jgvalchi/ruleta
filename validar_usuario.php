...
**Nombre de usuario: servicioCliente.
**Contraseña de usuario: servidor.
**base de datos:  dbruleta
**Si la conexion fallara mandamos un msj 'ha fallado la conexion'**/
mysql_connect('localhost','servicioCliente','servidor')or die ('Ha fallado la conexión: '.mysql_error());
 
/*Luego hacemos la conexión a la base de datos. 
**De igual manera mandamos un msj si hay algun error*/
mysql_select_db('dbruleta')or die ('Error al seleccionar la Base de Datos: '.mysql_error());
