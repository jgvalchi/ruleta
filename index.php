...
<?php
	...
	$first = true;
	$result= mysql_query("SELECT id, nombre_producto, filename, amount, special FROM premios where amount > 0 ORDER BY position ASC", $db);
...
?>			
			...
			function rotateWheel() {
				...
				drawRouletteWheel();
				spinTimeCounterout = setTimeout('rotateWheel()', 30);
			}
			...
			function removeWheelItem(index){
				$.post("kill.php", {id:wheelItems[index][wheel_id]}, function(result){/*console.log(result);*/}, "text");
					...
					<div class="caption text-center">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" class="btn btn-lg btn-primary" onClick="redireccionar();">
								<span class="glyphicon glyphicon-time" aria-hidden="true"></span> Concursantes <span class="glyphicon glyphicon-time" aria-hidden="true"></span>
							</button>
                            </p>
